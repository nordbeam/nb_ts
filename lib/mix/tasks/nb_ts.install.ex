  ...
  defmodule Mix.Tasks.NbTs.Install do
    ...
    defp print_welcome_message(igniter, skip_prompts) do
      unless skip_prompts do
        ...
        ╔═══════════════════════════════════════════════════════════════╗
        ║                                                               ║
        ║              Welcome to NbTs Installer                        ║
        ║                                                               ║
        ║   TypeScript Type Generation for Elixir                      ║
        ║                                                               ║
        ╚═══════════════════════════════════════════════════════════════╝
    ...
    defp print_next_steps(igniter, output_dir) do
      ...
      ╔═══════════════════════════════════════════════════════════════╗
      ║                                                               ║
      ║           NbTs Installation Complete!                         ║
      ║                                                               ║
      ╚═══════════════════════════════════════════════════════════════╝

      Installation Summary:
          ✓ NbTs core library
          ✓ Output directory configured: #{output_dir}
          ✓ Mix alias added: mix ts.gen
          ✓ Initial types will be generated
      ...
      Documentation & Resources:
        ...
        • NbTs Docs: https://hexdocs.pm/nb_ts
        • GitHub: https://github.com/nordbeam/nb_ts
        • NbSerializer: https://hexdocs.pm/nb_serializer
        • NbInertia: https://hexdocs.pm/nb_inertia
